...
public class EnglishCards extends Activity {
    Card Cards = new Card();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.english_cards);
    ...
    public void flipCard (View view){
        ...
        if(isFlip) {
            isFlip = false;
            Card.setText(Cards.russianCard.get(Cards.flipIndex));
            Cards.flipIndex++;
        }
    }
    ...
    public void rememberCard(View view) {
        ...
        if(Cards.flippedIndex < Cards.englishCard.size()) {
            Card.setText(Cards.englishCard.get(Cards.flippedIndex));
            Cards.flippedIndex++;
        }
        if(Cards.countCard == Cards.englishCard.size()){
            resultActivity();
        }
